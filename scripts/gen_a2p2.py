...
T = {
    "pt": {
        ...
        "v6_c1_rot": "O MEIO, ONDE QUASE TUDO ACONTECE",
    ...
    "en": {
        ...
        "v4_cols": ["PLATFORM", "BUILT-IN DEFAULT", "DOES THE CUSTOMER SEE THE VENDOR?", "CHOICE OFFERED"],
        "v4_r0_0": "Lovable",
        ...
        "v6_c1_rot": "THE MIDDLE, WHERE ALMOST EVERYTHING HAPPENS",
