...
scripts/           visual generators, the checkers and the experiment runner, in Python
experimentos/      pre-registered experiments with results: protocol, raw data, prompts
```
